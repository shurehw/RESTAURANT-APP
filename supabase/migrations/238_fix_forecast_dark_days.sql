-- ============================================================================
-- FIX: Preserve Prophet zero for dark/closed days in forecasts_with_bias
-- Problem: bias corrections (day_type_offset, holiday_offset) were inflating
--          covers_raw=0 rows into non-zero forecasts for closed days.
-- Fix: When Prophet wrote covers_predicted=0, keep everything zero.
-- ============================================================================
...
SELECT 'Fixed: dark/closed days now preserved as zero in forecasts_with_bias' as status;
