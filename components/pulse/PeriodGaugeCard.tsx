      ...
      <CardContent>
        ...
        {variancePct != null ? (
          <div className="mt-1 flex items-center gap-1 text-xs">
            ...
            <span className={variancePct >= 0 ? 'text-emerald-500' : 'text-red-500'}>
          ...
          prior === 0 && (
            <div className="mt-1 text-xs text-muted-foreground">No prior data</div>
          )
        )}
        ...
        {prior > 0 && (
          <div className="mt-1 text-xs text-muted-foreground">
            Prior: <span className="font-medium">{fmt(prior)}</span>
          </div>
        )}
