        ...
        {totalDeptCost > 0 && (
          <div className="mt-3">
            <div className="flex flex-wrap gap-x-3 text-[11px] text-muted-foreground mb-1">
              {fohCost > 0 && (
                <span>
                  <span className="inline-block w-1.5 h-1.5 rounded-full bg-keva-brass mr-1" />
                  FOH {fmt(fohCost)}
                  {netSales && netSales > 0 && (
              ...
              {bohCost > 0 && (
                <span>
                  <span className="inline-block w-1.5 h-1.5 rounded-full bg-keva-sage mr-1" />
                  BOH {fmt(bohCost)}
                  {netSales && netSales > 0 && (
            ...
            <div className="h-2 rounded-full bg-muted overflow-hidden flex">
              {fohPct > 0 && (
                <div
                  className="bg-keva-brass h-full transition-all"
                  style={{ width: `${fohPct}%` }}
                />
              )}
              {bohPct > 0 && (
                <div
                  className="bg-keva-sage h-full transition-all"
                  style={{ width: `${bohPct}%` }}
                />
              )}
              {otherPct > 0 && (
