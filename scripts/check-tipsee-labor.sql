...
-- Run with: psql "postgresql://finance_HAggarwal_read_only:finance_HAggarwal_read_only_password@tipsee-002.postgres.database.azure.com:5432/postgres?sslmode=require" -f scripts/check-tipsee-labor.sql
