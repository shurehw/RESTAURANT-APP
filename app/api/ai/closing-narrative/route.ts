...
export async function POST(request: NextRequest) {
  try {
    ...
    const input: ClosingNarrativeInput = {
      ...
      // Labor structured prompts (FOH/BOH split)
      ...
      foh_staffing_decision: body.foh_staffing_decision ?? null,
      boh_staffing_decision: body.boh_staffing_decision ?? null,
      ...
      foh_acknowledged: body.foh_acknowledged ?? false,
      boh_acknowledged: body.boh_acknowledged ?? false,
